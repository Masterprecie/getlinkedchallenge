...
const Intro = () => {
	return (
		<div className="lg:flex items-center py-16 bg-primary lg:px-32 px-10 relative">
			...
			<div className="lg:w-1/2 w-full relative pt-10 lg:pt-0 text-center lg:text-left ">
				<p className='text-[32px] font-bold text-white'>Introduction to getlinked</p>
				<p className='text-[32px] font-bold text-secondary'>tech Hackathon 1.0</p>
